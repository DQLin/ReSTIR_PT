...
def render_graph_HDRFLIPDemo():
    ...
    g.addEdge("GBufferRaster.diffuseOpacity", "PathTracerReference.mtlDiffOpacity")
    g.addEdge("GBufferRaster.specRough", "PathTracerReference.mtlSpecRough")
    g.addEdge("GBufferRaster.emissive", "PathTracerReference.mtlEmissive")
    g.addEdge("GBufferRaster.matlExtra", "PathTracerReference.mtlParams")
    ...
    g.addEdge("GBufferRaster.diffuseOpacity", "PathTracerTest.mtlDiffOpacity")
    g.addEdge("GBufferRaster.specRough", "PathTracerTest.mtlSpecRough")
    g.addEdge("GBufferRaster.emissive", "PathTracerTest.mtlEmissive")
    g.addEdge("GBufferRaster.matlExtra", "PathTracerTest.mtlParams")
